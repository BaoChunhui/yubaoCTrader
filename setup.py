...
def get_ext_modules() -> list:
    ...
    include_dirs = ["yubaoCtrader/tora_gateway/api/include", "yubaoCtrader/tora_gateway/api/include/tora", "yubaoCtrader/tora_gateway/api/vntora",
                    "yubaoCtrader/ctp_gateway/api/include", "yubaoCtrader/ctp_gateway/api/include/ctp", "yubaoCtrader/ctp_gateway/api/vnctp"]
    library_dirs = ["yubaoCtrader/tora_gateway/api/libs", "yubaoCtrader/tora_gateway/api",
                    "yubaoCtrader/ctp_gateway/api/libs", "yubaoCtrader/ctp_gateway/api"]
    ...
    vnctpmd = Extension(
        "yubaoCtrader.ctp_gateway.api.vnctpmd",
        ["yubaoCtrader/ctp_gateway/api/vnctp/vnctpmd/vnctpmd.cpp"],
        include_dirs=include_dirs,
        define_macros=[],
        undef_macros=[],
        library_dirs=library_dirs,
    ...
    vnctptd = Extension(
        "yubaoCtrader.ctp_gateway.api.vnctptd",
        ["yubaoCtrader/ctp_gateway/api/vnctp/vnctptd/vnctptd.cpp"],
        include_dirs=include_dirs,
        define_macros=[],
        undef_macros=[],
        library_dirs=library_dirs,
    ...
    return [vntoramd, vntoraoption, vntorastock, vnctpmd, vnctptd]
