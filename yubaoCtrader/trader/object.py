...
@dataclass
class UDPCapHeader(BaseData):
    """
    The link layer, network layer, and transport layer protocol headers for a UDP cap.
    Which contains EtherHeader、IPHeader and UdpHeader
    """

    # EtherHeader 14字节
    DestinationMAC: str = ""  # 长度6字节
    SourceMAC: str = ""  # 长度6字节
    EtherHeaderType: int = 0  # 长度2字节，0x0800(十进制的2048)表示ip协议

    # IPHeader  20字节
    Version: int = 0  # 长度0.5字节，4bit
    IPHeaderLength: int = 0  # 长度0.5字节，4bit
    # Tos = 0  # 长度1字节
    # TotalLengthip = 0  # 长度2字节
    # Token = 0  # 长度2字节
    # FlagAndOffset = 0  # 长度2字节
    # Ttl = 0  # 长度1字节
    Protocol: int = 0  # 长度1字节
    # CheckSumip = 0  # 长度2字节
    SourceIP: str = ""  # 长度4字节
    DestinationIP: str = ""  # 长度4字节

    # UdpHeader  8字节
    SourcePort: int = 0  # 长度2字节
    DestinationPort: int = 0  # 长度2字节
    TotalLengthudp: int = 0  # 长度2字节
    # CheckSumudp = 0  # 长度2字节
